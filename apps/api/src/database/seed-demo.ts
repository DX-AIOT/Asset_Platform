    ...
    const items = [
      {
        ...
        photos: [
          'https://images.unsplash.com/photo-1663499482523-1c0a8b0b1f1f?w=800',
        ],
        warrantyExpiry: new Date('2024-09-20'),
        notes: 'Deep Purple 256GB. Purchased from Apple Store. Original box and accessories included.',
